...
urlpatterns = [
    ...
    path('blogs/<int:blog_id>/likes/', views.blog_likes_check, name='blog_likes_check'),
    path('blogs/<int:blog_id>/comments/', views.blog_comments_check, name='blog_comments_check'),
